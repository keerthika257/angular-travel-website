...
@Component({
  ...
  template : ` 
   ...
   <div class="alert alert-success d-print-none" role="alert">
    Thank you so much <strong>{{customerDetails.firstName}} {{customerDetails.lastName}}</strong>.Your package has been booked successfully.
    <button class="btn btn-sm btn-info ml-2 mr-1" (click)="print()">Print Invoice</button><button class="btn btn-sm btn-info ml-1" (click)="clearCart()">Place a New Package</button>
                    ...
                    <table class="table table-clear">
                        <tbody>
                            <tr>
                                ...
                                <td class="right">LKR {{cart.cartTotal}}</td>
                            </tr>
                            ...
                            <tr>
                                ...
                                <td class="right">
                                    <strong>LKR {{cart.cartTotal}}</strong>
                                </td>
                            </tr>
